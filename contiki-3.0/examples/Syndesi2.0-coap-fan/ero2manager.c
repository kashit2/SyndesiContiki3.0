...
static void ero2heartbeat_handler(void* request, void* response, uint8_t *buffer, uint16_t preferred_size, int32_t *offset)
{
...
RESOURCE(ero2heartbeat, "title=\"Heartbeat\"", ero2heartbeat_handler, NULL, NULL, NULL);
...
void start_ero2_service(char* sp)
{
	...
	service_pointer=sp;
	init_registry();
	rest_activate_resource(&ero2heartbeat,"Heartbeat/ero2heartbeat");
